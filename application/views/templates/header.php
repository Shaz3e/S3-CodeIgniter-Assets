...
/**
 * Less Styles 
 * comment below lines on production machine
 */
?>
<link href="<?php echo asset_url('themes/styles/theme1.less'); ?>" rel="stylesheet/less" type="text/css">
...
<link rel="apple-touch-icon" sizes="180x180" href="<?php echo asset_url('images/favicon/apple-touch-icon-180x180.png');?>">
<link rel="icon" type="image/png" href="<?php echo asset_url('images/favicon/favicon-32x32.png" sizes="32x32');?>">
<link rel="icon" type="image/png" href="<?php echo asset_url('images/favicon/android-chrome-192x192.png" sizes="192x192');?>">
...
<link rel="mask-icon" href="<?php echo asset_url('images/favicon/safari-pinned-tab.svg');?>" color="#5bbad5">
<link rel="shortcut icon" href="<?php echo asset_url('images/favicon/favicon.ico');?>">
